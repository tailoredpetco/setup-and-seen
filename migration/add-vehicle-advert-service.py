...
<div class="vehicle-hero-copy"><p class="eyebrow">Vehicle advert management</p><h1>You sell the vans.<br><em>Leave the adverts to me.</em></h1><p class="vehicle-lead">Advert writing, photo preparation and stock updates for independent van dealers.</p><p class="vehicle-intro">Send your vehicle details and photographs. I will prepare your listings and keep your online stock up to date through your existing system.</p><a href="CTA" class="button primary">Enquire about advert support <span aria-hidden="true">↗</span></a><p class="vehicle-caption">Remote support across the UK. Your setup is checked before work is agreed.</p></div>
...
<section class="service-page-section section-pad"><div class="section-heading"><div><p class="eyebrow">Built around your existing setup</p><h2>Less listing admin.<br>More time for your business.</h2></div><p>For independent dealers who already have a website or stock system but need someone to prepare the adverts and handle agreed updates. No new website is required where your current setup is suitable.</p></div><div class="vehicle-fit"><div><h3>A good fit when…</h3><p>You have the vehicle facts and photographs, but preparing listings and keeping them current keeps slipping down the to-do list.</p></div><div><h3>A clear division of work</h3><p>You remain responsible for vehicle facts, prices, approvals and buyer enquiries. I handle the agreed preparation and listing work.</p></div></div></section>
