...
CARD_TEXT = 'Understand build prices, hosting, domains and monthly commitments, with worked examples using our published packages.'
...
new = 'Yes. We work with small businesses throughout the UK by phone, video call and online. If you prefer to meet in person, we can visit your business within 50 miles of our Worcestershire base by arrangement. Maria is your direct point of contact from the first conversation through to launch.'
service = service.replace(old, new)
service = map_chunks(service, lambda text: text.replace(old, new))
cost_link = f'<p class="website-cost-link"><a href="{ROUTE}">Read our guide to website build prices and ongoing costs →</a></p>'
if 'class="website-cost-link"' not in service:
    ...
    link_node = node('p', {'className': 'website-cost-link'}, node('a', {'href': ROUTE}, 'Read our guide to website build prices and ongoing costs →'))
...
<header class="article-hero section-pad"><nav class="breadcrumbs" aria-label="Breadcrumb"><a href="/">Home</a> / <a href="/advice">Advice &amp; guides</a></nav><p class="eyebrow">Plan your website budget</p><h1>How much does a small business website cost in the UK?</h1><p class="article-standfirst">A useful website quote explains the build, the ongoing costs and the work you need to provide. Here is how to compare your options, with real examples from our Set Up &amp; Seen packages.</p><div class="article-meta"><span>By Maria Flello, Set Up &amp; Seen</span><span>Published 12 September 2026</span></div></header>
<div class="article-layout section-pad"><aside class="article-summary"><p class="eyebrow">The short answer</p><p>Our Website Starter begins at £495 for a one-off build of up to five pages. Hosting and care are separate, from £49 a month. Our managed five-page option is £149 a month for 12 months, £1,788 total.</p><nav aria-label="In this guide"><a href="#compare-options">Compare the options</a><a href="#first-year-cost">Work out the first-year cost</a><a href="#ongoing-costs">Check ongoing costs</a><a href="#choose-scope">Choose the right scope</a></nav></aside>
<div class="article-body"><p class="article-opening">There is no single price that fits every UK small business. A simple service website and a vehicle stock website with filters, regular listings and integrations involve different work. The examples below are our published starting prices, rather than a UK-wide average or a promise that every project fits a fixed package.</p>
<section id="compare-options"><h2>What do our website packages cost?</h2><p>Start with the outcome you need: a clear website, a faster launch or a complete brand and website. These options have different inclusions.</p><div class="cost-options">
...
<div class="article-cta"><p class="eyebrow">A clear next step</p><h2>Tell us what your website needs to do.</h2><p>Share what your business does, whether you have an existing website and what you need customers to do next. We will recommend a suitable scope and explain the build and ongoing costs. No payment is taken when you enquire.</p><p>We work remotely across the UK, with phone and video consultations. Visits to customers within 50 miles of our Worcestershire base are available by arrangement.</p><a class="button primary" href="/?service=Website%20Starter#contact">Ask us for a website quote ↗</a></div>
</div></div></article>
'''
